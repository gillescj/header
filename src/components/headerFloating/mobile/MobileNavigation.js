        ...
        <Container>
            <Navbar>
                ...
                <Dropdown open={open}>
                    ...
                    <MobileNavItem to="/floating" name="Dropdown">
                        <MobileNavItemDropdown>
                            <MobileNavItem to="/floating" name="Option One" />

                            <MobileNavItem to="/floating" name="Option Two" />

                            <MobileNavItem to="/floating" name="Option Three" />
                        </MobileNavItemDropdown>
                    </MobileNavItem>
                </Dropdown>
            </Navbar>
